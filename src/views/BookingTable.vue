<template>
            ...
            <div class="main_menu">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="container">
                        ...
                        <a class="navbar-brand" href="index.html"><img style="height: 94px; width: 100px;" src="../Logo/logo_transparent.png" alt=""></a>
  ...
  <div class="carousel-inner">
    ...
    <div class="item">
		 <div class="container2">
                    <div class="row2 fullscreen d-flex align-items-center">
                        <div class="banner-content col-lg-12 justify-content-center" style="bottom:56px">
                            <h1 style="color:white">Masala Cheat</h1>
                            </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        console.log("Submit Clicked", typeof this.time)
            ...
            var config = {
              method: 'post',
              url: process.env.VUE_APP_domainkey + '/api/table/tableReservation',
              headers: { 
